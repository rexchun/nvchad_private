...
M.hide_statusline = function()
  local hidden =
    require("core.utils").load_config().plugins.options.statusline.hidden
  local shown =
    require("core.utils").load_config().plugins.options.statusline.shown
  local api = vim.api
    ...
    if present then
      ...
      if type(config) == "table" then
        ...
        print(
          "Warning: "
            .. config_name
            .. " sourced successfully but did not return a lua table."
        )
      end
    else
