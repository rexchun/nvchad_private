...
return packer.startup(function()
  ...
  local override_req = function(name, default_req)
    local override =
      require("core.utils").load_config().plugins.default_plugin_config_replace[name]
    local result
  ...
  use {
    ...
    config = override_req(
      "indent_blankline",
      "(plugins.configs.others).blankline()"
    ),
  }
  ...
  use {
    ...
    config = override_req(
      "nvim_colorizer",
      "(plugins.configs.others).colorizer()"
    ),
  }
  ...
  use {
    ...
    config = override_req(
      "nvim_autopairs",
      "(plugins.configs.others).autopairs()"
    ),
  }
